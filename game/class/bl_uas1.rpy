...
screen bl_uas_pti0:
    ...
    frame:
        xsize 1920
        ysize 1080
        background "images/kelas/pti-uas/bl_pti_0.png"

    imagebutton:
        xpos 1500
        ypos 950
        auto "tutorial/right_%s.png"
        action [Hide('bl_uas_pti0'), Show('bl_uas_pti1', dissolve)]
    ...
    imagebutton:
        ...
        action [Hide('bl_uas_pti0'), Return()]
...
screen bl_uas_pti1:
    ...
    frame:
        xsize 1920
        ysize 1080
        background "images/kelas/pti-uas/bl_pti_1.png"

    imagebutton:
        xpos 1500
        ypos 950
        auto "tutorial/left_%s.png"
        action [Hide('bl_uas_pti1'), Show('bl_uas_pti0', dissolve)]
    ...
    imagebutton:
        ...
        idle "menuUI/stats/return_idle.png"
        hover "menuUI/stats/return_hover.png"
        action [Hide('bl_uas_pti1'), Return()]

screen bl_uas_alpro0:

    frame:
        xsize 1920
        ysize 1080
        background "images/kelas/alpro-uas/bl_alpro_0.png"

    imagebutton:
        xpos 1500
        ypos 950
        auto "tutorial/right_%s.png"
        action [Hide('bl_uas_alpro0'), Show('bl_uas_alpro1', dissolve)]
    ...
    imagebutton:
        ...
        idle "menuUI/stats/return_idle.png"
        hover "menuUI/stats/return_hover.png"
        action [Hide('bl_uas_alpro0'), Return()]

screen bl_uas_alpro1:

    frame:
        xsize 1920
        ysize 1080
        background "images/kelas/alpro-uas/bl_alpro_1.png"

    imagebutton:
        xpos 1500
        ypos 950
        auto "tutorial/left_%s.png"
        action [Hide('bl_uas_alpro1'), Show('bl_uas_alpro0', dissolve)]
    ...
    imagebutton:
        ...
        idle "menuUI/stats/return_idle.png"
        hover "menuUI/stats/return_hover.png"
        action [Hide('bl_uas_alpro1'), Return()]
...
screen bl_uas_de0:
    ...
    frame:
        xsize 1920
        ysize 1080
        background "images/kelas/de-uas/bl_de_0.png"

    imagebutton:
        xpos 1500
        ypos 950
        auto "tutorial/right_%s.png"
        action [Hide('bl_uas_de0'), Show('bl_uas_de1', dissolve)]
...
screen bl_uas_de1:
    ...
    frame:
        xsize 1920
        ysize 1080
        background "images/kelas/de-uas/bl_de_1.png"

    imagebutton:
        xpos 1500
        ypos 950
        auto "tutorial/left_%s.png"
        action [Hide('bl_uas_de1'), Show('bl_uas_de0', dissolve)]
    ...
    imagebutton:
        ...
        idle "menuUI/stats/return_idle.png"
        hover "menuUI/stats/return_hover.png"
        action [Hide('bl_uas_de1'), Return()]

screen bl_uas_strukdat0:
