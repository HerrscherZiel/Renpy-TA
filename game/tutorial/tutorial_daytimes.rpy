...
screen tutorial_daytimes1:

    frame:
        xsize 1920
        ysize 1080

        background "tutorial/tutorial_daytime1.png"
...
screen tutorial_daytimes2:
    ...
    frame:
        xsize 1920
        ysize 1080
        background "tutorial/tutorial_daytime2.png"
    ...
    imagebutton:
        ...
        action  [Hide("tutorial_daytimes2"), Show("tutorial_daytimes1")]
